# CpG Island Annotation: Emboss: http://emboss.open-bio.org/html/use/apbs06.html#GroupsAppsTableNucleiccpgislandsR6
	module load emboss; module load postgresql; cpgplot ~/genomes/panubis1/Panubis1.0.fa -outfeat panubis1.emboss.newcpgreport.gff -outfile panubis1.emboss.out -noplot #default settings 
