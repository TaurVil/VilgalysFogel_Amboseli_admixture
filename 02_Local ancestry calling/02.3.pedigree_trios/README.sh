...
awk '{OFS="\t"; print >> ("aims_maskedSNPRCref_" $1 ".txt")}' amb.majrule.txt # generates chromosome-specific files of ancestry calls across all Amboseli individuals 
awk '{OFS="\t"; print >> ("aims_unmaskedWallref_" $1 ".txt")}' amb.majrule.txt # generates chromosome-specific files of ancestry calls across all Amboseli individuals 
