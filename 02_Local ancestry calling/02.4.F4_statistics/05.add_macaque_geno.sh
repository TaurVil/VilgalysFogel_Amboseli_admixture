...
sed 's/$/\t0\/0:49,0:49:99:0,120,1800/g' noheader.baboon.to.macam.n51.CHROMOSOME.filtused.recode.vcf >> tmp.CHROMOSOME.vcf

# Add macaque as the name of our newly added sample
sed '/^#CHROM/ {s/$/\tmacaque/}' ../baboon.to.macam.n51.CHROMOSOME.filtused.recode.vcf >> tmp2.CHROMOSOME.vcf
...
cat header.CHROMOSOME tmp.CHROMOSOME.vcf >> final.baboon.to.macam.n48.CHROMOSOME.vcf

# Bgzip and index our new vcf
bgzip final.baboon.to.macam.n51.CHROMOSOME.vcf  
tabix final.baboon.to.macam.n51.CHROMOSOME.vcf.gz
