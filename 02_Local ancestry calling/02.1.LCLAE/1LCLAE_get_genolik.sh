...
vcftools --max-alleles 2 --gzvcf amboseli_with_masked_refpanel.$chrom.recode.vcf.gz --recode --out amboseli_with_masked_refpanel.max2.$chrom
...
# LCLAE/filtbaboon1b XXX <-- XXX specifies the TOTAL number of individuals in the file (includes reference individuals -- e.g., unadmixed yellow and anubis -- and admixed individuals)
