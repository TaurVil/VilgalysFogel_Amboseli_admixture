...
plotA <- ggplot(data = baboon, aes(x=fixed_quant, y=mean_ancestry)) + 
  ...
  theme_classic() + 
  theme(text=element_text(size=14, family="Helvetica"), axis.text = element_text(color="black"), legend.position = "none", axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.title.x = element_text(vjust=-2), plot.margin = margin(b=10))  + 
...
plotB <- ggplot() + 
  ...
  theme(text=element_text(size=14, family="Helvetica"), axis.text = element_text(color="black"), axis.text.x=element_blank(),axis.ticks.x=element_blank(), legend.position = "none", axis.title.x = element_text(vjust=-2), plot.margin = margin(l=20, b=10))  + 
...
(((plotDleft + theme(plot.margin = unit(c(0,0,20,0), "pt"))) | plotDright) + xlab(label = "number of fixed differences per Mb") + theme(axis.title.x = element_text( hjust=2.25, vjust=-0.3))) / (((plotEleft + theme(plot.margin = unit(c(0,0,20,0), "pt"))) | plotEright) + xlab(label = "rank-ordered B values") + theme(axis.title.x = element_text(hjust=-6,vjust=-0.3))) / (((plotFleft + theme(plot.margin = unit(c(0,0,20,0), "pt"))) | plotFright) + xlab(label = "rank-ordered recombination rate") + theme(axis.title.x = element_text(hjust=3, vjust=-0.3)))
