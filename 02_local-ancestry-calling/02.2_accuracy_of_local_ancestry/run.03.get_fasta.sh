...
python ~/Programs/neat-genreads/neat-genreads-master/genReads.py -r ./partial_genome/CHROMO.fa -R 101 -o ./sim_reads/INDIV.CHROMO -c 10 -v ./simulated_vcfs/fixed.INDIV.CHROMO.vcf -M 0 --rng 10 --gz --vcf
...
#paired end (pe) with mean length 300 and sd of 30: --pe 300 30
#output true vcf: --vcf
