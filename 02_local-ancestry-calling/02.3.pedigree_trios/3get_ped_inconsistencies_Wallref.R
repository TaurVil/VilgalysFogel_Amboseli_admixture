...
# Load R data file for the unmasked Wall reference panel generated in 1prep_for_pedigree_inconsistencies.R script
load("local_ancestry_pedigree_trios_unmaskedWallref.Rd")

# Load all ancestry calls for all individuals in the pedigree trios at all sites of interest across the genome
calls <- read.table("all.ancestry_calls_unmaskedWallref_pedigree_trios_35kbpos.txt", header=T)
...
save(inconsistent, inconsistent_error, calls_record, file="inconsistent_local_ancestry_calls_pedigree_trios_unmaskedWallref.Rd")
print("done")
q(save="no")
