...
# Load pedigree trio data (generated by the run.01.prep_for_pedigree_inconsistencies.R script), ancestry state inconsistency results (generated by the run.03.get_ped_inconsistencies_SNPRCref.R script), and covariate data (generated by the run.04 scripts) for the SNPRC reference panel
...
fst <- read.table("fst_masked_unmerged_SNPRCref_35kbwin_500bpstep.windowed.weir.fst", header=T) # FST
...
# if you did not include ancestry informative markers, FST, and recombination data for the Wall et al. reference panel
...
# reload data frames for the SNPRC reference panel
load("local_ancestry_pedigree_trios_maskedSNPRCref.Rd", verbose=T)
load("inconsistent_local_ancestry_calls_pedigree_trios_maskedSNPRCref.Rd", verbose=T) 
...
#save(inconsistent_maskedSNPRCref, inconsistent_unmaskedWallref, trios_inconsistencies, file="inconsistencies_results.Rd")
