...
yel_SNPRC <- unlist(read.delim("./DATA/00_yel_SNPRC.list", header=F))
yel_mikumi <- unlist(read.delim("./DATA/00_yel_mikumi.list", header=F))
anu_SNPRC <- unlist(read.delim("./DATA/00_anu_SNPRC.list", header=F))
anu_mara <- unlist(read.delim("./DATA/00_anu_mara.list", header=F))
anu_WNPRC <- unlist(read.delim("./DATA/00_anu_WNPRC.list", header=F))

lclae$pop <- "bgp_anubis"; lclae$pop[lclae$name %in% yel_SNPRC] <- "SNPRC yellow"; lclae$pop[lclae$name %in% yel_mikumi] <- "Mik yellow"
lclae$pop[lclae$name %in% anu_SNPRC] <- "SNPRC anubis"; lclae$pop[lclae$name %in% anu_mara] <- "Mara anubis"; lclae$pop[lclae$name %in% anu_WNPRC] <- "WNPRC anubis"

lclae$spec <- "anubis"; lclae$spec[lclae$name %in% yel_SNPRC] <- "yellow"; lclae$spec[lclae$name %in% yel_mikumi] <- "yellow"
lclae$spec[lclae$name %in% anu_SNPRC] <- "anubis"; lclae$spec[lclae$name %in% anu_mara] <- "anubis"; lclae$spec[lclae$name %in% anu_WNPRC] <- "anubis"
...
lclae_res$pop <- "1_Aberdares anubis"; lclae_res$pop[lclae_res$name %in% yel_SNPRC] <- "6_Southwest yellow"; lclae_res$pop[lclae_res$name %in% yel_mikumi] <- "5_Mikumi yellow"
lclae_res$pop[lclae_res$name %in% c(anu_SNPRC, "panu_L142", "panu_LIV5")] <- "3_Southwest anubis"; lclae_res$pop[lclae_res$name %in% anu_mara] <- "2_Masai Mara anubis"; lclae_res$pop[lclae_res$name %in% anu_WNPRC] <- "4_WNPRC anubis"

lclae_res$spec <- "anubis"; lclae_res$spec[lclae_res$name %in% yel_SNPRC] <- "yellow"; lclae_res$spec[lclae_res$name %in% yel_mikumi] <- "yellow"
lclae_res$spec[lclae_res$name %in% anu_SNPRC] <- "anubis"; lclae_res$spec[lclae_res$name %in% anu_mara] <- "anubis"; lclae_res$spec[lclae_res$name %in% anu_WNPRC] <- "anubis"
